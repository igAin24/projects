...
stop.addEventListener("click",
  function() {
    ...
    if (timer.textContent.substring(0, 5) == "00:10"){
      playSound(2);
      fireworks[0].style.background = "rgba(0,0,0,0)";
...
reset.addEventListener("click",
  function() {
    ...
    fireworks[0].style.background = "rgba(233, 168, 227, 0.6)";
  }
);
...
let music;
function soundStart(){
  music = new Audio("sound/start.mp3");
  music.play();
}
function soundStop(){
  music = new Audio("sound/stop1.mp3");
  music.play();
}
function soundReset(){
  music = new Audio("sound/reset.mp3");
  music.play();
}
let sound = ["sound/start.mp3","sound/stop1.mp3","sound/stop2.mp3","sound/reset.mp3"];
function playSound(n){
  music = new Audio(sound[n]);
  music.play();
}